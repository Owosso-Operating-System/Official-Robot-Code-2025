...
public class LiftCoralTwo extends Command {
     ...
     * Uses addRequirements to tie LiftSubsystem to LiftCoralTwo
     */

    public LiftCoralTwo(LiftSubsystem liftSubsystem, XboxController auxiliaryController) {
  ...
  public void execute() {
    ...
    if(auxiliaryController.getRightBumperButton() && (auxiliaryController.getRawAxis(1) < 0.1 && auxiliaryController.getRawAxis(1) > -0.1)){
