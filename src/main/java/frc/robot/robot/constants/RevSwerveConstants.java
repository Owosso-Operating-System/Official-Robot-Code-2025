...
public final class RevSwerveConstants 
{
    ...
    /* Front Left Module - Module 0 */
        public static final class Mod0 { 
            ...
            public static final Rotation2d rotOffset = Rotation2d.fromRotations(0.80493164062);
        ...
        public static final class Mod1 { 
            ...
            public static final Rotation2d rotOffset = Rotation2d.fromRotations(-0.2734375);
            public static final RevSwerveModuleConstants constants = 
                new RevSwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, rotOffset);
        }
        ...
        public static final class Mod2 { 
            ...
            public static final Rotation2d rotOffset = Rotation2d.fromRotations(0.73803710938 + 0.216064453125);
            public static final RevSwerveModuleConstants constants = 
                new RevSwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, rotOffset);
        }
        ...
        public static final class Mod3 { 
            ...
            public static final Rotation2d rotOffset = Rotation2d.fromRotations(0.44653320312);
            public static final RevSwerveModuleConstants constants = 
                new RevSwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, rotOffset);
        }
